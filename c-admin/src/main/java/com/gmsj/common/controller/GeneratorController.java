...
import com.gmsj.common.utils.GenUtils;
import com.gmsj.common.service.GeneratorService;
...
public class GeneratorController {
	...
	public void code(HttpServletRequest request, HttpServletResponse response,
		...
		response.reset();
		response.setHeader("Content-Disposition", "attachment; filename=\"gmsj-platform.zip\"");
	...
	@ResponseBody
	@PostMapping("/update")
    RestResp update(@RequestParam Map<String, Object> map) {
		try {
			...
			return RestResp.error(1, "保存配置文件出错");
		}
		return RestResp.ok("保存配置成功");
	}
}

 ...
 * @version $Id: WebToolsUtils.java, v 0.1 2017年6月20日 下午6:02:14 Administrator Exp $
 */
public class WebToolsUtils {
    ...
    public static final String getClientIp() {
        return ip(((ServletRequestAttributes) RequestContextHolder.getRequestAttributes()).getRequest());
    }
